...
public class TimePostFilter extends ZuulFilter{
	...
	public Object run() throws ZuulException {
		...
		log.info(String.format("Tiempo transcurrido en millisegundos %s seg."), tiempoTranscurrido);
		log.info(String.format("%s request enrutado", request.getMethod(), request.getRequestURL().toString()));
